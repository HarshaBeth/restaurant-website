...
const Navbar = () => {
  return (
    <div className='h-32 bg-gray-950 flex space-x-52 items-center px-28 fixed top-0 z-50 w-screen'>

        <div className='text-white text-4xl font-bold'>
            GERÍCHT
        </div>

        <div className='text-white flex space-x-9 text-base font-semibold pl-20'>
        ...
        <div className='text-white flex space-x-3 text-base items-center font-sans font-semibold pl-24'>
