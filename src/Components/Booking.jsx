...
const Booking = () => {
  return (
    <div className='h-screen bg-gray-950' id='7'>
            ...
            <div className='relative -top-3 flex flex-row justify-end pr-48'>
            ...
            <div className='w-[100%] h-[70%]  flex flex-row items-center justify-center'>
                ...
                <div className='w-[60%] bg-gray-900 border-solid border border-gray-500 h-96 flex flex-col justify-center items-center'>
                    ...
                    <div className='space-x-7 pt-8'>
                        <select name="people" id="" className='bg-gray-950 text-white w-64 h-10 border border-solid border-gray-500 px-3 text-sm'>
                        ...
                        <select name="date" id="" className='bg-gray-950 text-white w-64 h-10 border border-solid border-gray-500 px-3 text-sm font-semibold'>
                            <option className='text-yellow-200'>
                                23 / 07 / 2023
