                        ...
                        <div className='pt-10 flex flex-row items-center space-x-7 max-md:space-x-0  max-md:divide-x-2 max-md:divide-yellow-200'>
                                ...
                                <div className='pt-8 space-y-6'>
                                    ...
                                    <div className='flex flex-col'>
                                        <div className='flex flex-row items-center space-x-5'>
                                            <span className='pr-14 text-yellow-200 max-lg:pr-5'>Chicken Biryani</span>
                                    ...
                                    <div className='flex flex-col'>
                                        <div className='flex flex-row items-center space-x-5'>
                                            <span className='pr-16 text-yellow-200 max-lg:pr-7'>Butter Chicken</span>
                                            <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                    ...
                                    <div className='flex flex-col'>
                                        <div className='flex flex-row items-center space-x-5'>
                                            <span className='pr-12 text-yellow-200 max-lg:pr-3'>Tandoori Chicken</span>
                                            <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                    ...
                                    <div className='flex flex-col'>
                                        <div className='flex flex-row items-center space-x-5'>
                                            <span className='pr-9 text-yellow-200 max-lg:pr-0'>Naan Bread Combo</span>
                                            <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                        ...
                                        <div className=' text-gray-400 text-xs font-normal space-x-2 pt-1'>
                                            ...
                                            <span className='!font-sans '>|</span>
                                            <span className='!font-sans lg:hidden md:inline sm:hidden'>...</span>
                                            <span className='!font-sans max-lg:hidden max-md:inline max-sm:hidden'>Kulcha Naan</span>
                                        </div>
                                    </div>

                                    <div className='flex flex-col'>
                                        <div className='flex flex-row items-center space-x-5'>
                                            <span className='pr-20 mr-2.5 text-yellow-200 max-lg:pr-11'>Fish Curry</span>
                                            <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                            ...
                            <div className='text-white flex flex-col items-center max-md:pl-3'>
                                ...
                                <div className='pt-8 space-y-6'>
                                    ...
                                    <div className='flex flex-col'>
                                        <div className='flex flex-row items-center space-x-5'>
                                            <span className='pr-10 text-yellow-200 max-lg:pr-2'>Chicken Fried Rice</span>
                                            <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                    ...
                                    <div className='flex flex-col'>
                                        <div className='flex flex-row items-center space-x-4'>
                                            <span className='pr-20 mr-3 text-yellow-200 max-lg:pr-12'>Dumplings </span>
                                            <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                    ...
                                    <div className='flex flex-col'>
                                        <div className='flex flex-row items-center space-x-4'>
                                            <span className='pr-20 mr-1 text-yellow-200 max-lg:pr-12'>Spring Rolls</span>
                                            <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                    ...
                                    <div className='flex flex-col'>
                                        <div className='flex flex-row items-center space-x-5'>
                                            <span className='pr-8 text-yellow-200 max-lg:pr-0'>Chow Mein Noodles</span>
                                            <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                            <span className='!font-serif'>$12</span>
                                        </div>
                                        {/* Bottle Size */}
                                    ...
                                    <div className='flex flex-col'>
                                        <div className='flex flex-row items-center space-x-5'>
                                            <span className='pr-16 mr-2 text-yellow-200 max-lg:pr-8'>Wonton Soup</span>
                                            <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
