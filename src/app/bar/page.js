        ...
        <div className='h-screen w-full bg-cover bg-center bg-[url("/BG_small.svg")] relative'>
            ...
            <div className='h-screen flex justify-center'>
                ...
                <div className='h-screen w-full flex flex-col justify-center items-center'>
                    <Image  src={pic} width={650} className='max-lg:w-[32rem] max-sm:w-[24rem] max-sm:-mt-16  mt-20'/>
                </div>
                    ...
                    <div className='pt-10 flex flex-row items-center space-x-7 max-md:space-x-0  max-md:divide-x-2 max-md:divide-yellow-200'>
                            ...
                            <div className='pt-8 space-y-6'>
                                ...
                                <div className='flex flex-col'>
                                    <div className='flex flex-row items-center space-x-5'>
                                        <span className='pr-4 text-yellow-200 max-lg:pr-0'>Chapel Hill Shiraz</span>
                                ...
                                <div className='flex flex-col'>
                                    <div className='flex flex-row items-center space-x-5'>
                                        <span className='pr-9 text-yellow-200 max-lg:pr-5'>Catena Malbec</span>
                                        <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                ...
                                <div className='flex flex-col'>
                                    <div className='flex flex-row items-center space-x-5'>
                                        <span className='pr-9 text-yellow-200 max-lg:pr-5'>La Vieille Rosé</span>
                                        <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                ...
                                <div className='flex flex-col'>
                                    <div className='flex flex-row items-center space-x-5'>
                                        <span className='pr-9 text-yellow-200 max-lg:pr-5'>Rhino Pale Ale</span>
                                        <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                ...
                                <div className='flex flex-col'>
                                    <div className='flex flex-row items-center space-x-5'>
                                        <span className='pr-10 text-yellow-200 max-lg:pr-6'>Irish Guinness</span>
                                        <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                        ...
                        <div className='text-white flex flex-col items-center max-md:pl-3'>
                            ...
                            <div className='pt-8 space-y-6'>
                                ...
                                <div className='flex flex-col'>
                                    <div className='flex flex-row items-center space-x-5'>
                                        <span className='pr-16 text-yellow-200 max-lg:pr-7'>Aperol Spritz</span>
                                        <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                    ...
                                    <div className=' text-gray-400 text-xs font-normal space-x-2 pt-1'>
                                        ...
                                        <span className='!font-sans '>|</span>
                                        <span className='!font-sans max-sm:hidden'>Villa Marchesi prosecco</span>
                                        <span className='!font-sans max-sm:hidden'>|</span>
                                        <span className='!font-sans max-lg:hidden max-sm:inline'>soda</span>
                                ...
                                <div className='flex flex-col'>
                                    <div className='flex flex-row items-center space-x-4'>
                                        <span className='pr-12 text-yellow-200 max-lg:pr-3'>Dark 'N' Stormy</span>
                                        <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                    ...
                                    <div className=' text-gray-400 text-xs font-normal space-x-2 pt-1'>
                                        ...
                                        <span className='!font-sans max-sm:hidden'>Slice of lime</span>
                                    </div>
                                </div>

                                <div className='flex flex-col'>
                                    <div className='flex flex-row items-center space-x-5'>
                                        <span className='pr-24 text-yellow-200 max-lg:pr-14'>Daiquiri</span>
                                        <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                ...
                                <div className='flex flex-col'>
                                    <div className='flex flex-row items-center space-x-5'>
                                        <span className='pr-14 text-yellow-200 max-lg:pr-5'>Old Fashioned</span>
                                        <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                        <span className='!font-serif'>$31</span>
                                    </div>
                                    {/* Bottle Size */}
                                ...
                                <div className='flex flex-col'>
                                    <div className='flex flex-row items-center space-x-5'>
                                        <span className='pr-24 text-yellow-200 max-lg:pr-14'>Negroni</span>
                                        <hr className='h-px bg-white border-0 w-20 max-lg:w-10 max-sm:w-2'/>
                                    ...
                                    <div className=' text-gray-400 text-xs font-normal space-x-2 pt-1'>
                                        ...
                                        <span className='!font-sans lg:hidden'>...</span>
                                        <span className='!font-sans max-lg:hidden'>Orange garnish</span>
                                    </div>
                                </div>
                            </div>
